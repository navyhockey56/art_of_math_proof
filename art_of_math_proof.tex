...
\\
and we'll define an integer to be any number within the set of integers. We'll also endow the integers with the familiar operation of addition; which we will discuss in more detail in just a few sections.    
...
\\
Further on in this article, we will actually prove that the associative, communtative, and distributive properties of multiplication do hold. But for now, we shall accept them as psuedo-axiomatic to prevent ourselves from getting too lost in the details.
