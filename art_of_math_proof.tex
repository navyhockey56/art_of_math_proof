...
\\
$\rightarrow$ Furthermore, $s$ is not only even, it's also the sum of $n$ and $m$ - which were represented in such a way that our argument could apply to any pair of even integers, thus we have completed our proof! \\
\\
...
Furthermore, $s$ is not only even, it's also the sum of $n$ and $m$ - thus we have completed our proof. \\
\end{document}